...
def get_token(request):
    ...
    try:
        ...
        if not PUBLIC_KEY:
            return JsonResponse({'error': 'Izipay public key is not configured.'}, status=500)
        ...
        response = requests.post(
            url=os.environ.get('IZIPAY_TOKEN_URL', 'https://sandbox-checkout.izipay.pe/apidemo/v1/Token/Generate'),
            json=payload,
            headers={
